...
<html lang="it">
<head>
    @php($title = "Elenco CoA Definitivi Idonei")
...
<body class="d-flex flex-column min-vh-100">
    ...
    <main class="container-fluid mt-3 flex-grow-1">
        <div class="row">
            {{-- La sidebar è stata aggiunta qui, ma potrebbe essere necessario creare un file sidebar specifico per questa sezione --}}
            <div class="col-md-2">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Elenco CoA idonei</li>
                        </ol>
                    </nav>
                </div>
                            ...
                            <tr>
                                <td>
                                    <a target='_blank' href="doc/definitivi_idonei/{{$definitivo->codice_associato_master}}.pdf">
                                        <button type="button" class="btn btn-success"><i class="fas fa-file-pdf"></i></button>
                                    </a>
                                </td>
                                <td>
    ...
    <script src="{{ URL::asset('/') }}dist/js/elenco_definitivi.js?ver=1.002"></script>
